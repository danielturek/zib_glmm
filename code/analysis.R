...
##You can see the new model specification below, without the latent `z` variables, and using the custom `dOccupancy` distribution for the observations `y`.  This model can only be used with NIMBLE.
